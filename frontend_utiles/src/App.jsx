...
const App = () => {
      ...
      <section className="kpi-grid">
        ...
        <div className="card">
          <div className="card-header">
            ...
            <ShieldCheck size={16} color="#1BAA6F" />
          </div>
      ...
      <div className="sections-grid">
        <section className="chart-section">
          <div className="section-title">
            <TrendingUp size={20} color="#1BAA6F" />
              ...
              <AreaChart data={data}>
                <defs>
                  <linearGradient id="colorEngage" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#1BAA6F" stopOpacity={0.3} />
                    <stop offset="95%" stopColor="#1BAA6F" stopOpacity={0} />
                  </linearGradient>
                </defs>
        ...
        <section className="feed-section">
          <div className="section-title">
            <MessageSquare size={20} color="#9BD53C" />
          ...
          <div className="feed-list">
            ...
            <div className="feed-item" style={{ borderColor: '#9BD53C' }}>
          ...
          <div key={camp.id} className="card" style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1fr 1fr', alignItems: 'center', gap: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ height: '6px', background: 'rgba(255,255,255,0.1)', borderRadius: '3px' }}>
                <div style={{ width: `${camp.progress}%`, height: '100%', background: '#1BAA6F' }}></div>
              </div>
            </div>
            ...
            <div style={{ textAlign: 'center' }}>
              <span style={{ padding: '0.2rem 0.5rem', borderRadius: '6px', fontSize: '0.7rem', background: 'rgba(0,135,81,0.1)', color: '#1BAA6F' }}>{camp.status}</span>
            </div>
  ...
  const renderAgents = () => (
    <div className="agents-view" style={{ animation: 'fadeIn 0.5s ease-out' }}>
      <header className="section-title" style={{ marginBottom: '2rem' }}>
        <ShieldCheck size={24} color="#1BAA6F" />
      ...
      <div className="kpi-grid">
        {agentsData.map(agent => (
          <div key={agent.id} className="card">
            ...
            <p style={{ fontSize: '0.9rem', color: '#1BAA6F', fontWeight: 'bold' }}>{agent.role}</p>
    ...
    <div className="studio-view" style={{ animation: 'fadeIn 0.5s ease-out' }}>
      ...
      <div className="sections-grid" style={{ gridTemplateColumns: 'minmax(300px, 350px) 1fr' }}>
        <div className="card">
          ...
          <textarea style={{ width: '100%', minHeight: '100px', margin: '1rem 0', background: 'rgba(0,0,0,0.2)', color: 'white', border: '1px solid var(--glass-border)', padding: '1rem', borderRadius: '8px' }} placeholder="Sujet du clip..."></textarea>
          <button onClick={startStudioProduction} style={{ width: '100%', padding: '1rem', background: 'var(--primary)', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold' }}>
  ...
  const renderAnalytics = () => (
    <div className="analytics-view" style={{ animation: 'fadeIn 0.5s ease-out' }}>
      <header className="section-title" style={{ marginBottom: '2rem' }}>
        <TrendingUp size={24} color="#1BAA6F" />
      ...
      <div className="kpi-grid">
          ...
          <div style={{ height: '100px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={analyticsData}>
                <Area type="monotone" dataKey="followers" stroke="#1BAA6F" fill="#1BAA6F" fillOpacity={0.1} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
        <div className="card">
          ...
          <div style={{ height: '100px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={analyticsData}>
                <Area type="monotone" dataKey="clips" stroke="#9BD53C" fill="#9BD53C" fillOpacity={0.1} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
